    ...
    $.extend(FixedHeader.prototype, {
        ...
        _modeChange: function (mode, item, forceChange) {
            ...
            if (mode === 'in-place') {
                ...
                if (item === 'header') {
                    if ($(itemDom.host).find("thead").length <= 0) {
                        itemDom.host.prepend(this.dom.thead);
                    }
                }
                else {
                    if ($(itemDom.host).find("tfoot").length <= 0) {
        ...
        _positions: function () {
            ...
            if (!this.initTheadTop && position.theadTop.toString().indexOf('.') == -1 && position.theadTop > 0) {
                this.initTheadTop = position.theadTop;
                this.initPosition = $.extend(true, {}, position);
            }
        },
